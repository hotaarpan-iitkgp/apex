    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-slate-900/90 p-2 rounded-2xl border border-slate-800 shadow-md">
        <div className="flex flex-wrap gap-1.5">
          {courseVideoSeries.map((course) => {
            ...
            return (
              ...
              >
                <Tv className={`h-4 w-4 ${isSelected ? 'text-white' : 'text-slate-400'}`} />
        ...
        <div className="relative min-w-[200px] sm:max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-1.5 text-xs rounded-xl bg-slate-950 border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-slate-800 text-white space-y-2">
            <div className="flex items-center gap-2">
              ...
              return (
                ...
                >
                  ...
                  <div className="px-4 py-3 bg-slate-950/80 border-b border-slate-800 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded bg-red-500/15 text-red-400 text-[10px] font-mono font-bold uppercase border border-red-500/20">
                        Module {module.moduleNumber}
                      </span>
                      <h5 className="font-serif font-bold text-xs sm:text-sm text-white">
                        {module.moduleTitle}
                      </h5>
                    </div>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left p-3 sm:p-3.5 flex items-start gap-3 transition-colors ${
                            isPlaying
                              ? "bg-red-500/15 text-white border-l-4 border-l-red-500"
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 space-y-1">
                            ...
                            <p className={`text-xs font-medium leading-snug line-clamp-2 ${
                              isPlaying ? "font-bold text-white" : "text-slate-300"
                            }`}>
                              {video.title}
                            </p>
                          </div>
